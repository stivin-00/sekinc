    ...
    <div class="footersection" id="footerdiv" onMouseOver={closeSubmenu}>
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 col-12 footer-div text-center">
            <div>
              ...
              <p>
                ...
                adipisci recusandae sed natus, beatae quidem! Maiores in ut,
                aliquid quia ea debitis sunt fugiat quod.
              </p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-12 footer-div text-center">
          ...
          <div class="col-lg-4 col-md-6 col-12 footer-div text-center">
            <div>
              ...
              <p>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Soluta
                adipisci recusandae sed natus, beatae{" "}
              </p>
        ...
        <div class="mt-5 text-center">
          <svg id="footer" viewBox="0 0 999 174">
            <path
        ...
        <div class="mt-5 text-center">
          <p>
            Copyrigth &copy;2019 All rights reserved | powered by{" "}
            <a href="sek-inc">sek-inc</a>
          </p>
        </div>
      </div>
